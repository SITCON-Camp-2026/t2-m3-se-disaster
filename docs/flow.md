...
- 如果輸入內容包含真實個資、真實電話、真實地址、真實人物或真實災情，流程應要求改寫或拒絕保存。
...
送出前，系統先檢查這筆內容是否含真實個資、真實地址、真實電話、真實人物或真實災情。如果有，這筆資料不得保存，並提醒觀測者改寫成安全的課堂練習資料。如果沒有，資料保存為本機未整理草稿，狀態固定為需要人工確認。

資訊整理者查看資料時，先比較原文、資訊取得方式、來源角色與時間。整理者判斷原文清楚度：原文模糊、原文簡略、原文清晰。這個判斷只描述原文是否支撐整理判斷，不代表資料已查核。

如果資料來源角色不明、內容模糊、時間不清楚、可能含個資、或會讓行動者誤解，資料標示為需要人工確認，且不能直接變成任務。
...
flowchart TD
  ...
  B["觀測者新增資料"] --> B1{"是否含真實個資、地址、電話、人物或災情？"}
  B1 -->|是| B2["拒絕保存，提醒改寫成安全練習資料"]
  B1 -->|否| B3["保存為本機未整理草稿"]
  B3 --> C
...
- 不儲存內容：真實個資、真實電話、真實地址、真實人物資料、真實災情資料、API key 或 secrets。
- 建議資料欄位：
  - `localId`：本機產生的臨時 ID。
...
- 觀測者輸入是否含真實個資、真實地址、真實電話、真實人物或真實災情。
...
- 含真實個資或真實災情的輸入不能被 AI 自動改寫成安全資料；需要使用者自行改寫或放棄保存。

## 操作或判斷紀錄

- 觀測者新增資料：記錄建立時間、來源角色、資訊取得方式與觀測者自填的不確定處。
- 本機資料修改：記錄修改時間與修改欄位，不需要記錄真實個資。
- 整理者判斷原文清楚度：記錄判斷值與理由。
